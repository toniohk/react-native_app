    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer} style={styles.scrollView}>
        <View style={styles.centeredView}>
          <TouchableHighlight style={styles.navigationContainer} onPress={() => navigation.navigate('CreateInventory')}>
          ...
          <TouchableHighlight style={styles.navigationContainer} onPress={() => navigation.navigate('InventoryList')}>
            <View style={styles.navigationContainerView}>
              <View style={styles.titleSection}>
