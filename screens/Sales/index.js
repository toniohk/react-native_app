    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer} style={styles.scrollView}>
        <View style={styles.centeredView}>
          <TouchableHighlight style={styles.navigationContainer} onPress={() => navigation.navigate('SalesCustomer', { type: 'sale' })}>
            <View style={styles.navigationContainerView}>
              <View style={styles.titleSection}>
                <Text style={styles.title}>Start a sale</Text>
              </View>
          ...
          <TouchableHighlight style={styles.navigationContainer} onPress={() => navigation.navigate('SalesCustomer', { type: 'trade' })}>
            <View style={styles.navigationContainerView}>
              <View style={styles.titleSection}>
