      ...
      serviceAPI.createCustomer(customerData)
        .then(response => {
          if (response.CustomerID) {
            if (type === 'sale') navigation.navigate('CreditPull', { customerID: response.CustomerID });
            else if (type === 'trade') navigation.navigate('ProcessTradeIn', { customerID: response.CustomerID });
            else {
